...
export default async function DashboardPage() {
  ...
  const completed = await prisma.task.count({ where: { teamId: { in: teamIds }, status: "done" } });
  const inProgress = await prisma.task.count({ where: { teamId: { in: teamIds }, NOT: { status: "done" } } });
